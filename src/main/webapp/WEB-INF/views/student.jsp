...
<form  action="studentloginprocess" modelAttribute="student" >
					<table>
					<caption></caption>
					<th></th>
					<tr><td style="color:navy;"><strong> Login Form</strong></td></tr>
					<tr><td><br></td></tr>
					<tr><td><strong>StudentName:<strong></strong></td><td><input type="text" name="name"/></td></tr>
								<tr><td><br></td></tr>
					<tr><td><strong>Password:<strong></strong></td><td><input type="password" name="mobile"/></td></tr>	
							<tr><td><br></td></tr>
