...
<div id="header">
	...
	<div class="container">
		...
		<h3>Accountant Directory</h3>
		<hr>

		<p class="h4 mb-4">New Accountant</p>

		<form action="/Management/create" >

			<!-- Add hidden form field to handle update -->
			<input type="hidden" name="id" value="${payregister.id}" />

			<div class="form-inline">
				<input type="text" name="username" value="${payregister.username}"
			...
			<div class="form-inline">
				...
				<input type="text" name="userpass" value="${payregister.userpass}"
			...
			<div class="form-inline">
					<select name="branch" value="${payregister.branch}" class="form-control mb-4 col-4" >
			...
			<div class="form-inline">
				...
				<input type="text" name="dateofjoining" value="${payregister.dateofjoining}"
			...
			<div class="form-inline">
				...
				<input type="text" name="dateofbirth" value="${payregister.dateofbirth}"
			...
			<div class="form-inline">
				...
				<input type="text" name="salary" value="${payregister.salary}"
					class="form-control mb-4 col-4" placeholder="Salary">
