			...
			<tbody>
				<c:forEach items="${Students}" var="tempStudent">
					<tr>
						...
						<td><c:out value="${tempStudent.mobile}" /></td>
						<td><c:out value="${tempStudent.feesub}" /></td>
						<td><c:out value="${tempStudent.fee}" /></td>
						<td><c:out value="${tempStudent.paid}" /></td>
						<td><c:out value="${tempStudent.balance}" /></td>
						<td><c:out value="${tempStudent.address}" /></td>
						<td><c:out value="${tempStudent.fathername}" /></td>
						<td><c:out value="${tempStudent.mothername}" /></td>
						<td><c:out value="${tempStudent.dateofbirth}" /></td>
						<td><c:out value="${tempStudent.qualification}" /></td>
						<td><c:out value="${tempStudent.dateofjoining}" /></td>
						<td><c:out value="${tempStudent.description}" /></td>
						<td><c:out value="${tempStudent.trainer}" /></td>
						<td>
							<!-- Add "update" button/link --> <a
							href="/Management/showFormForUpdate?studentId=${tempStudent.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a href="/Management/delete?studentId=${tempStudent.id}"
