...
<link rel="stylesheet" type="text/css" href="style.css" />
	...
	<div id="header">
			...
			<div class="captions">
				...
				<img src="https://www.northpropertygroup.co.uk/wp-content/uploads/Halo-Manchester-City-Centre-1000x300.jpg" alt="" />							
			</div>
			...
			<div id="nav">
					<ul>
						...
						<li>
							<a href="/Management/showFormForAddPayregister">Create New Accountant</a>
						</li>
						<li>
							<a href="/Management/view">View Accountant</a>
						</li>
						<li>
							<a href="/Management/list">View Student Detail</a>
						</li>						
					</ul><br class="clear" />
				</div>
<form:form  action="editsavepay" modelAttribute="payregister">
...
<tr><td>Branch:</td><td><select name="branch" id="select">
					...
					<tr><td><br></td></tr>
<tr><td>Find:-</td><td><input type="text"  name="username" placeholder="Accountant Name"></input></td></tr></table>
