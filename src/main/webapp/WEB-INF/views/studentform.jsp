		...
		<form action="/Management/save" >
			...
			<div class="form-inline">
				...
				<input type="text" name="mobile" value="${Student.mobile}"
					class="form-control mb-4 col-4" placeholder="Mobile">
			...
			<div class="form-inline">
				...
				<input type="text" name="feesub" value="${Student.feesub}"
					class="form-control mb-4 col-4" placeholder="Feesubmission">
			...
			<div class="form-inline">
				...
				<input type="text" name="fee" value="${Student.fee}"
					class="form-control mb-4 col-4" placeholder="Fee">
			...
			<div class="form-inline">
				...
				<input type="text" name="paid" value="${Student.paid}"
					class="form-control mb-4 col-4" placeholder="Paid">
			...
			<div class="form-inline">
				...
				<input type="text" name="fathername" value="${Student.fathername}"
					class="form-control mb-4 col-4" placeholder="Fathername">
			...
			<div class="form-inline">
				...
				<input type="text" name="mothername" value="${Student.mothername}"
					class="form-control mb-4 col-4" placeholder="Mothername">
			...
			<div class="form-inline">
				...
				<input type="text" name="dateofbirth" value="${Student.dateofbirth}"
					class="form-control mb-4 col-4" placeholder="Dateofbirth">
			...
			<div class="form-inline">
				...
				<input type="text" name="qualification" value="${Student.qualification}"
					class="form-control mb-4 col-4" placeholder="Qualification">
			...
			<div class="form-inline">
				...
				<input type="text" name="dateofjoining" value="${Student.dateofjoining}"
					class="form-control mb-4 col-4" placeholder="Dateofjoining">
			...
			<div class="form-inline">
				...
				<input type="text" name="description" value="${Student.description}"
			...
			<div class="form-inline">
				...
				<input type="text" name="trainer" value="${Student.trainer}"
					class="form-control mb-4 col-4" placeholder="Trainer">
